@echo off
REM ============================================================================
REM backup-coupe-maison.bat - Wrapper pour backup-coupe-maison.ps1
...
set "SCRIPT_DIR=%~dp0"
set "PS_SCRIPT=%SCRIPT_DIR%backup-coupe-maison.ps1"

if not exist "%PS_SCRIPT%" (
    echo.
    echo ERREUR : backup-coupe-maison.ps1 introuvable dans :
    echo   %SCRIPT_DIR%
    echo.
...
echo.
echo ============================================
echo   Backup coupe-maison
echo ============================================
echo.
echo   Cible : C:\Agile\coupe-maison_YYYYMMDD-HHmmss.zip
echo.
