# ============================================================================
# backup-coupe-maison.ps1 — Backup ZIP du repo coupe-maison sans node_modules
# Sortie : C:\Agile\coupe-maison_YYYYMMDD-HHmmss.zip
#
# Usage :
#   .\backup-coupe-maison.ps1                                       # backup complet
#   .\backup-coupe-maison.ps1 -ExcludeGit                           # sans .git
#   .\backup-coupe-maison.ps1 -ExcludeDb                            # sans data\*.db
#   .\backup-coupe-maison.ps1 -ExcludeBak                           # sans .bak / copies
#   .\backup-coupe-maison.ps1 -ExcludeGit -ExcludeDb -ExcludeBak    # minimal
#
# Exclusions par defaut (toujours) : node_modules, .cache, logs, dist, build
#
# Si bloque par MOTW (transfere via ZIP/email) :
#   Unblock-File .\backup-coupe-maison.ps1
# ============================================================================

[CmdletBinding()]
param(
    [string]$Source  = "C:\Agile\coupe-maison",
